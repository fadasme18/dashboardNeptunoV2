...
@Component({
  ...
  styleUrl: './horno4.component.scss'
})
export class Horno4Component implements OnInit, OnDestroy {
  ...
  public estado_horno1F2: Boolean | null = null;
    ...
    startPolling(intervalMs: number): void {
      const apiUrl = 'http://192.168.1.18:1880/api/f1horno4'; //EDITAR A GUSTO
    ...
    fetchGraphData(
      ...
      const MEDICION_OBJETIVO = 'F1-Horno4-[COUNTIS-E53]'; // CAMBIAR NOMBRE AL MEASUREMENT CORRESPONDIENTE
