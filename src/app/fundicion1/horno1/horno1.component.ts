...
export class Horno1Component implements OnInit, OnDestroy {
  ...
  startPolling(intervalMs: number): void {
    const apiUrl = 'http://192.168.1.18:1880/api/f1horno1'; //EDITAR A GUSTO
  ...
  fetchGraphData(
    ...
    const MEDICION_OBJETIVO = 'F1-Horno1-[DPM-C530]'; // CAMBIAR NOMBRE AL MEASUREMENT CORRESPONDIENTE
