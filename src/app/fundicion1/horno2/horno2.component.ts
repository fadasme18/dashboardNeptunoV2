...
@Component({
  ...
  styleUrl: './horno2.component.scss'
})
export class Horno2Component implements OnInit, OnDestroy {
  ...
  public estado_horno1F2: Boolean | null = null;
    ...
    startPolling(intervalMs: number): void {
      const apiUrl = 'http://192.168.1.18:1880/api/f1horno2'; //EDITAR A GUSTO
    ...
    fetchGraphData(
      ...
      const MEDICION_OBJETIVO = 'F1-Horno2-[COUNTIS-E53]'; // CAMBIAR NOMBRE AL MEASUREMENT CORRESPONDIENTE
