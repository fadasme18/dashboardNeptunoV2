...
@Component({
  ...
  templateUrl: './horno1.component.html',
  styleUrl: './horno1.component.scss'
})
export class Horno1Component implements OnInit, OnDestroy {
  ...
  startPolling(intervalMs: number): void {
    const apiUrl = 'http://192.168.1.18:1880/api/f2horno1'; //EDITAR A GUSTO
  ...
  fetchGraphData(
    ...
    const MEDICION_OBJETIVO = 'F2-Horno1-[COUNTIS-E53]'; // CAMBIAR NOMBRE AL MEASUREMENT CORRESPONDIENTE
