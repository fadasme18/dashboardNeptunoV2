...
export class Horno2Component implements OnInit, OnDestroy {
  ...
  startPolling(intervalMs: number): void {
    const apiUrl = 'http://192.168.1.18:1880/api/f2horno2'; //EDITAR A GUSTO
  ...
  fetchGraphData(
    ...
    const MEDICION_OBJETIVO = 'F2-Horno2-[DPM-C530]'; // CAMBIAR NOMBRE AL MEASUREMENT CORRESPONDIENTE
